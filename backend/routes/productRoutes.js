...
import { getProducts, addProduct, getSections, getClassifications,getProductBySlug } from "../controllers/productController.js";
...
router.get("/:slug", getProductBySlug); // /api/products/classifications
